...
static u64 gdt[NUM_GDT_DESC] = {
    [GDT_DESC_NULL] = 0,
    [GDT_DESC_CODE] = (1ull << 43) | (1ull << 44) | (1ull << 47) |
                      (1ull << 53), // 0x00af9b000000ffffUL,
...
int save_linux() {
  ...
  // set r11 to 1
  asm volatile("movq $1, %%r11" : : : "r11");

  // set CS
  // set_cs(GDT_DESC_CODE * 8);

  // set r11 to 2
  asm volatile("movq $2, %%r11" : : : "r11");
...
void restore_linux() {
  ...
  // set r13 to 1
  asm volatile("movq $1, %%r13" : : : "r13");

  asm volatile("ltr %%ax" : : "a"(data.tss.selector));

  // set r13 to 2
  asm volatile("movq $2, %%r13" : : : "r13");
  ...
  // restore CS
  // set r14 to 1
  asm volatile("movq $1, %%r14" : : : "r14");

  // set_cs(data.cs.selector);

  // set r14 to 2
  asm volatile("movq $2, %%r14" : : : "r14");
