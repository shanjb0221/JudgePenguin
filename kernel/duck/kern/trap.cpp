...
void init() {
    ...
    // fix TSS
    uintptr_t task_state_addr = (uintptr_t)&task_state;
    gdt[GDT_TSS >> 3] = (sizeof(TaskState) - 1) | ((task_state_addr & 0xffffff) << 16) | (9ul << 40) | (0ul << 45) |
                        (1ul << 47) | (1ul << 53) | ((task_state_addr >> 24) << 56);
    gdt[(GDT_TSS >> 3) + 1] = (task_state_addr) >> 32;
